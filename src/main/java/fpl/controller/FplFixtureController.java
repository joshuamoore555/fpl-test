...
public class FplFixtureController {
    ...
    public ResponseEntity<Object> getTeamSpecificFixtures(@PathVariable String teamName) throws IOException {
    ...
    public ResponseEntity<Object> getTeamSpecificFutureFixtures(@PathVariable String teamName) throws IOException {
